...
private const val TAG = "Display Main Activity"
class DisplayMap : AppCompatActivity(), OnMapReadyCallback {

    private lateinit var mMap: GoogleMap
    private  lateinit var favShops:FavShops
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        mMap = googleMap
        Log.i(TAG,"user mapt to remer : ${favShops.title}")

        val boundsBuilder = LatLngBounds.Builder()
        for(place in favShops.places) {
